...
// GET /api/admin/comments — List ALL comments across the whole site
router.get('/comments', async (req, res) => {
  try {
    const comments = await Comment.find()
      .populate('author', 'name email') // See who wrote it
      .populate('post', 'title') // See which post they commented on
